...
- Renders a circular face, 12 tick marks, an outer Roman numeral ring, an inner
  Arabic numeral ring, and distinct hour, minute, and second hands.
...
- `index.html` contains the page shell and inline SVG clock markup, including
  static precomputed numeral positions.
- `styles.css` owns the page reset, centering, responsive SVG sizing, and analog
  face, numeral, and hand styling.
...
- Preserve the SVG hand selectors: `#hand-hour`, `#hand-minute`, and
  `#hand-second`.
- Preserve numeral styling hooks: `.numeral.roman` and `.numeral.arabic`.
